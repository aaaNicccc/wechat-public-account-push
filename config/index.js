export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID:wx0f78070669684848"",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET:2293b97a68351facc92d79cb68b11ab7"",
  ...
  USERS: [
    {
      ...
      id: oL9Vj6DG0oVt4942PwXrzH10ZKPw"",
      // 
      useTemplateId:TaKJS-SaRCcs14Y8PHTdz_F_R2aAIU29VNd0NHhR5ps "",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
